...
public static class SetsAndMaps
{
    ...
    public static Dictionary<string, int> SummarizeDegrees(string filename)
    {
        ...
        foreach (var line in File.ReadLines(filename))
        {
            ...
            // Extract the degree from the 4th column (index 3)
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        foreach (char c in word2)
        {
            ...
            if (letterCounts[c] < 0)
                return false; // more occurrences in word2
        }
   ...
   public static string[] EarthquakeDailySummary()
{
    ...
    foreach (var feature in featureCollection.Features)
    {
        ...
        if (props == null || props.Place == null || !props.Mag.HasValue)
            continue;

        string place = props.Place.Trim();
        string magnitude = props.Mag.Value.ToString("F1");

        // <-- The format the test expects:
